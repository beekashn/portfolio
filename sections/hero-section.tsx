...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-[6%] top-[8%] h-56 w-56 rounded-full bg-primary/8 blur-[110px]"
      />
      <div
        aria-hidden="true"
        ...
        <div className="grid gap-10 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p
                data-hero="fade"
                className="text-xl font-display font-medium tracking-tight text-muted-foreground"
              >
              ...
              <p
                data-hero="fade"
                className="max-w-xl text-base leading-8 text-muted-foreground font-serif sm:text-lg"
              >
                I build secure, maintainable backend systems with an emphasis on
                clarity, thoughtful architecture, and smooth delivery.
              </p>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {stats.map((stat) => (
                    ...
                    >
                      <p className="text-xl font-display font-bold tracking-tight gradient-text">
                        {stat.value}
                      </p>
